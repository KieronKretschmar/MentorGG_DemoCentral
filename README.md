...
- `MENTORINTERFACE_BASE_ADDRESS` : HTTP URL to base api like "https://api.mentor.gg"", supply "mock" to create an endpoint that always returns the lowest subscription
