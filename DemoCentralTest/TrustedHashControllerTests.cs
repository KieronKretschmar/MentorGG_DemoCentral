...
namespace DemoCentralTests
{
    ...
    public class TrustedHashControllerTests
    {
        ...
        private readonly IDemoDBInterface mockIDemoDBInterface;
        ...
        public TrustedHashControllerTests()
        {
            ...
            mockIDemoDBInterface = new Mock<IDemoDBInterface>().Object;
        }

        [TestMethod]
        public void CreateHashReturnsHTTPConflictIfDuplicated()
        {
            var mockIDemoDBInterface = new Mock<IDemoDBInterface>();
            long matchId = 1;
