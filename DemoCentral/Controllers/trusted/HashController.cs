...
namespace DemoCentral.Controllers.trusted
{
    ...
    public class HashController : ControllerBase
    {
        ...
        public ActionResult CreateHash(long matchId,byte frames, string hash)
        {
            bool duplicateHash = _dbInterface.IsDuplicateHash(hash, out long duplicateMatchId, frames);
